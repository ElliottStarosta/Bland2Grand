    ...
    const wave = () =>
      dots.forEach((d, i) => {
        gsap.to(d, {
          ...
          ease: "power1.inOut",
          onComplete: () => {
            gsap.to(d, { opacity: 1, duration: 0.3, ease: "power1.out" });
          },
        });
      });
    ...
    >
      ...
      <div
        style={{
          ...
          pointerEvents: "none",
          background:
            "radial-gradient(ellipse 110% 80% at 50% 50%, transparent 25%, #0C0B09 88%)",
        }}
      />
      ...
      <div
        style={{
          ...
          height: 1,
          background:
            "linear-gradient(90deg, transparent, rgba(212,116,46,0.45), transparent)",
        }}
      />
      ...
      <div
        style={{
          ...
          height: 1,
          background:
            "linear-gradient(90deg, transparent, rgba(212,116,46,0.2), transparent)",
        }}
      />
    </div>
  );
